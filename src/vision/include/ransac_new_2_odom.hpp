#ifndef RANSAC_NEW_2_ODOM
#define RANSAC_NEW_2_ODOM
...
#include <classify_lanes_odom.hpp>
...
// ros_centroid_l.header.frame_id = "odom";
// ros_centroid_r.header.frame_id = "odom";
// ros_centroid_prev_r.header.frame_id = "odom";
// ros_centroid_prev_l.header.frame_id = "odom";
...
#define dist_between_lanes 0.01
...
Parabola classify_lanes(Mat img,Parabola present,Parabola previous, vector<Point> ptArray1)
{
...
Parabola no_sudden_change(Parabola bestTempParam, Mat img, Parabola previous, vector<Point> ptArray1)
{
    if(bestTempParam.numModel==2 && previous.numModel == 2)
    {
        bestTempParam = classify_lanes(img, bestTempParam, previous, ptArray1);
...
Parabola getRansacModel(Mat img,Parabola previous)
{
    ...
    //     }       
    // }
    param=classify_lanes(img,param,previous,ptArray1);
