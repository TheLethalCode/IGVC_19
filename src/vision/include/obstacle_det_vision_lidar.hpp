...
Mat remove_white_obstacles(Mat output, Mat img1) {
    ...
    for(int  i = 0; i < img1.rows; i++)
    {
        for (int j = 0; j < img1.cols; j++)
        {
            ...
            if(i<img1.rows/4)
                n = 10;
            else if(i>=img1.rows/5 && i < img1.rows*2/5)
                n = 25;
            else if(i>=img1.rows*2/5 && i < img1.rows*3/5)
                n = 40;
            else if(i>=img1.rows*3/4)
                n = 50;
            // if(i<img1.rows/4)
            //   n = 20;
            // else if(i>=img1.rows/5 && i < img1.rows*2/5)
            ...
            // else if(i>=img1.rows*3/4)
            //   n = 70;
            //n = (10 + ((50*(i+1))/img1.rows));
            if ((abs(img1.at<Vec3b>(i, j)[0] - img1.at<Vec3b>(i, j)[1]) < img1.at<Vec3b>(i, j)[0]*0.2 && abs(img1.at<Vec3b>(i, j)[1] - img1.at<Vec3b>(i, j)[2]) < img1.at<Vec3b>(i, j)[1]*0.2 && abs(img1.at<Vec3b>(i, j)[2] - img1.at<Vec3b>(i, j)[0]) < img1.at<Vec3b>(i, j)[2]*0.2) ||
                    img1.at<Vec3b>(i, j)[0] > 150 && img1.at<Vec3b>(i, j)[1] > 150 && img1.at<Vec3b>(i, j)[2]>150)
            {
                check = 1;
                for(int k = (-1)*(n/2); k < (n/2)+1; k++)
                {
                    ...
                    {
                        if(i+k >=0 && i+k < img1.rows && j+l >=0 && j+l <img1.cols)
                        {
                            if(img1.at<Vec3b>(i+k, j+l)[0] < img1.at<Vec3b>(i+k, j+l)[1]*2/3 && img1.at<Vec3b>(i+k, j+l)[2] < 1.3*img1.at<Vec3b>(i+k, j+l)[1] && img1.at<Vec3b>(i+k, j+l)[2] > 0.7*img1.at<Vec3b>(i+k, j+l)[1])
                                count++;
                            if(count > n/3)
                                l = n;
                            k = n;
...
Mat remove_obstacles(Mat img, Mat processed, vector<Point> obs_lidar) {
